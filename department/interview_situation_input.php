    ...
    <table width="920" class="table">
      <thead>
        <tr>
          ...
          <th width="72">姓名</th>
          <th width="54">性别</th>
          <th width="112">联系电话</th>
          <th width="91">志愿顺序</th>
          <th width="99">第一轮面试</th>
          <th width="97">第二轮面试</th>
          <th width="98">操作</th>
        </tr>
      </thead>
      <tbody>
...
$selectStmt_Total=$pdo->prepare("select * from student_status join student_choice on student_status.student_id=student_choice.student_id
    ...
    join student_interview_condition on student_interview_condition.student_id = student_status.student_id
    ...
    for ($i=$start_index ; $i <=$end_index; $i++) {
        if ($arr[$i][student_id]!="") {
            ...
            if ($arr[$i][first_choice] == $id) {
                ...
                if ($arr[$i][first_choice_first_round] == "unsure") {
                    $display_message.='<td>未录入<img src="images/question.png" width="20" height="20"></td>';
                }
                else if ($arr[$i][first_choice_first_round] == "pass"){
                    $display_message.='<td>面试通过<img src="images/right.png" width="20" height="20"></td>';
                }
                else if ($arr[$i][first_choice_first_round] == "notpass") {
                    $display_message.='<td>未通过<img src="images/wrong.png" width="20" height="20"></td>';
                }
                else {
                    $display_message.='<td>系统故障<img src="images/question.png" width="20" height="20"></td>';
                }
            
                if ($arr[$i][first_choice_second_round] == "unsure") {
                    $display_message.='<td>未录入<img src="images/question.png" width="20" height="20"></td>';
                }
                else if ($arr[$i][first_choice_second_round] == "pass"){
                    $display_message.='<td>面试通过<img src="images/right.png" width="20" height="20"></td>';
                }
                else if ($arr[$i][first_choice_second_round] == "notpass") {
                    $display_message.='<td>未通过<img src="images/wrong.png" width="20" height="20"></td>';
                }
                else {
                    $display_message.='<td>系统故障<img src="images/question.png" width="20" height="20"></td>';
                ...
                if ($arr[$i][second_choice_first_round] == "unsure") {
                    $display_message.='<td>未录入<img src="images/question.png" width="20" height="20"></td>';
                }
                else if ($arr[$i][second_choice_first_round] == "pass"){
                    $display_message.='<td>面试通过<img src="images/right.png" width="20" height="20"></td>';
                }
                else if ($arr[$i][second_choice_first_round] == "notpass") {
                    $display_message.='<td>未通过<img src="images/wrong.png" width="20" height="20"></td>';
                }
                else {
                    $display_message.='<td>系统故障<img src="images/question.png" width="20" height="20"></td>';
                ...
                if ($arr[$i][second_choice_second_round] == "unsure") {
                    $display_message.='<td>未录入<img src="images/question.png" width="20" height="20"></td>';
                }
                else if ($arr[$i][second_choice_second_round] == "pass"){
                    $display_message.='<td>面试通过<img src="images/right.png" width="20" height="20"></td>';
                }
                else if ($arr[$i][second_choice_second_round] == "notpass") {
                    $display_message.='<td>未通过<img src="images/wrong.png" width="20" height="20"></td>';
                }
                else {
                    $display_message.='<td>系统故障<img src="images/question.png" width="20" height="20"></td>';
            ...
            $display_message.="<td>";
            $display_message.='<a href="interview_situation.php?student_id='.$arr[$i][student_id].$tailMessage.'" class="btn btn-primary"><i class="icon-hand-right"></i> 录入</a>';
