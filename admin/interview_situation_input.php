...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="container-fluid">
        ...
        <div class="span9">
            <h1 class="page-title">报名人员删除与状态重置</h1>
...
//           <td>网络部</td>
//           <td>考评部</td>
//           <td>已确认<img src="images/right.png" width="20" height="20"></td>
//           <td>
//                <a href="interview_situation.php?student_id=B13010812" class="btn btn-primary"><i class="icon-hand-right"></i> 操作</a>
//           </td>
//         </tr>
//         <tr>
//           <td>2</td>
...
//           <td>宣传部</td>
//           <td>秘书处</td>
//           <td>未确认<img src="images/wrong.png" width="20" height="20"></td>
//           <td>
//              <a href="interview_situation.php?student_id=B13010812" class="btn btn-primary"><i class="icon-hand-right"></i> 操作</a>
//           </td>
//         </tr>
...
if ($totalCount!=0) {
    ...
    for ($i=$start_index ; $i <=$end_index; $i++) {
        if ($arr[$i][student_id]!="") {
            ...
            $pdo->query("set names 'utf8'");
            $selectStmt_department_name->bindValue(':first_choice', $arr[$i][first_choice]);
            $selectStmt_department_name->bindValue(':second_choice', $arr[$i][second_choice]);
            ...
            $display_message.="<td>".$first_choice_name."</td>";
            $display_message.="<td>".$second_choice_name."</td>";
            if ($arr[$i][ifconfirm] == 1) {
                $display_message.='<td>已确认<img src="images/right.png" width="20" height="20"></td>';
            }
            else {
                $display_message.='<td>未确认<img src="images/wrong.png" width="20" height="20"></td>';
            }
            $display_message.="<td>";
            $display_message.='<a href="interview_situation.php?student_id='.$arr[$i][student_id].'&'.$tailMessage.'" class="btn btn-primary"><i class="icon-hand-right"></i> 操作</a>';
