  ...
  <!--<![endif]-->
    ...
    <div class="container-fluid">
 	  ...
 	  <p class="block-heading"> 
     		部门ID：#department_id#<br> 
     		部门名称：#department_name#<br>
      <a href="department_information.php" class="btn btn-primary"><i class="icon-download"></i>返回部门总览页面</a>
        </p>
               
            <p class="block-heading">对该部门进行操作</p>
                <div class="well">
    <table class="table">
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
          <td>密码重置</td>
          <td>
           <a href="reset_password.php?department_id=#department_id#" class="btn btn-primary" onclick= "if(confirm( '是否确定重置该部门密码？ ')==false)return   false; ">重置</a>
          </tr>
        <tr>
          <td>修改部门名称</td>
          <td>
          <form action="situation_change.php?department_id=#department_id#" method="post">
          	<input type="hidden" name="department_id" id="department_id">
              <input type="text" name="department_name" id="department_name">
<input type="submit" id="" name="" value="修改" class="btn btn-primary" onclick= "if(confirm( '是否确认修改该部门名称？ ')==false)return   false; else GetRequest(); ">
              </form>
              </td>
          </tr>
        <tr>
          <td>删除部门</td>
          <td>
            <a href="delete_department.php?department_id=#department_id#" class="btn btn-primary" onclick= "if(confirm( '是否确定删除该部门？（删除后可能会使用已报名的同学找不到该部门，请三思而后行） ')==false)return   false; ">删除</a>
          </td>
          </tr>
      </tbody>
    </table>
...
$display_block_1=preg_replace('/#department_id#/', $department_id, $display_block_1);
$display_block_1=preg_replace('/#department_name#/', $department_name, $display_block_1);
