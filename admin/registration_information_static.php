...
<div class="block">
      <p class="block-heading">共查找到#TotalNumber#条注册记录，以下是信息统计：</p>
                <div class="block-body">
                <div class="row-fluid">
                
                      <table class="table-condensed offset2" border="1" cellspacing="0" cellpadding="0">
        <tr>
          <td width="138"><p align="center">部门名称</p></td>
          <td width="138"><p align="center">第一志愿人数</p></td>
          <td width="138"><p align="center">第二志愿人数</p></td>
          <td width="138"><p align="center">总人数</p></td>
        </tr>
END_OF_TEXT;
...
//         <tr>
//           <td width="138"><p align="center">网络部</p></td>
//           <td width="138"><p align="center">10</p></td>
//           <td width="138"><p align="center">10</p></td>
//           <td width="138"><p align="center">20</p></td>
//         </tr>
//         <tr>
//           <td width="138"><p align="center">考评部</p></td>
//           <td width="138"><p align="center">10</p></td>
//           <td width="138"><p align="center">10</p></td>
//           <td width="138"><p align="center">20</p></td>
//         </tr>
//         <tr>
//           <td width="138"><p align="center">宣传部</p></td>
//           <td width="138"><p align="center">10</p></td>
//           <td width="138"><p align="center">10</p></td>
//           <td width="138"><p align="center">20</p></td>
//         </tr>
//         <tr>
//           <td width="138"><p align="center">秘书处</p></td>
//           <td width="138"><p align="center">10</p></td>
//           <td width="138"><p align="center">10</p></td>
//           <td width="138"><p align="center">20</p></td>
//         </tr>
...
$pdo->query("set names 'utf8'");
$selectStmt_student_basic_information=$pdo->prepare("select * from student_basic_information
    join student_choice on student_basic_information.student_id = student_choice.student_id 
    ");
$selectStmt_school_major=$pdo->prepare("select * from school_major");
$selectStmt_department_basic_information=$pdo->prepare("select * from department_basic_information");

$selectStmt_student_basic_information->execute();
$arr=$selectStmt_student_basic_information->fetchAll();
$rowcount=$selectStmt_student_basic_information->rowCount();
...
$arr_department=$selectStmt_department_basic_information->fetchAll();
$rowcount_department=$selectStmt_department_basic_information->rowCount();
...
for ($i = 0; $i < $rowcount; $i++) {
    $first_contain[$arr[$i][first_choice]]++;
    $second_contain[$arr[$i][second_choice]]++;
    if ($arr[$i][sex]=="male") {
        $contain[male]++;
    }
    ...
    $contain[$arr[$i][school]]++;
}


for ($i = 0; $i < $rowcount_department; $i++) {
    $show=<<<END_OF_TEXT
            <tr>
              <td width="138"><p align="center">#部门#</p></td>
              <td width="138"><p align="center">#第一志愿#</p></td>
              <td width="138"><p align="center">#第二志愿#</p></td>
              <td width="138"><p align="center">#总数#</p></td>
            </tr>
END_OF_TEXT;
    $show=preg_replace('/#部门#/', $arr_department[$i][department_name], $show);
    $show=preg_replace('/#第一志愿#/', $first_contain[$arr_department[$i][id]]+0, $show);
    $show=preg_replace('/#第二志愿#/', $second_contain[$arr_department[$i][id]]+0, $show);
    $show=preg_replace('/#总数#/', $first_contain[$arr_department[$i][id]]+$second_contain[$arr_department[$i][id]] , $show);
    $showMessage.=$show;
}


$display_block_1=preg_replace('/#男人数#/', $contain[male]+0, $display_block_1);
$display_block_1=preg_replace('/#女人数#/', $contain[female]+0, $display_block_1);
$display_block_1=preg_replace('/#未知人数#/', $contain[unknown_sex]+0, $display_block_1);
$display_block_2=preg_replace('/#TotalNumber#/', $rowcount, $display_block_2);
...
echo $display_block_1.$show_school_static.$display_block_2.$showMessage.$display_block_3;
